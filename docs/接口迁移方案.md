...
| 文件 | API_MODE | BASE_URL | API_DOMAIN |
|------|----------|----------|------------|
| `.env.development` | `proxy` | `http://app.rtesp.com` | `rtesp.com` |
| `.env.test` | `proxy` | `http://app.rtesp.com` | `rtesp.com` |
| `.env.prod` | `proxy` | `https://app.rongtrip.cn` | `rongtrip.cn` |
...
```json
{
  ...
  "dev:h5:test": "VITE_BASE_PATH=/h5/ VITE_DEV_PORT=5173 pnpm --filter @ryx/h5 dev --mode test",
  "dev:h5:prod": "VITE_BASE_PATH=/h5/ VITE_DEV_PORT=5175 pnpm --filter @ryx/h5 dev --mode prod",
  "dev:web:test": "VITE_BASE_PATH=/web/ VITE_DEV_PORT=5174 pnpm --filter @ryx/web dev --mode test",
  "dev:web:prod": "VITE_BASE_PATH=/web/ VITE_DEV_PORT=5176 pnpm --filter @ryx/web dev --mode prod",
