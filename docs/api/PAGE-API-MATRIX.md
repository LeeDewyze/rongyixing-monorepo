...
| 8    | 账户设置      | `account-setting_ryx`         | `/me/settings`           | Account-\*                                                                                  | [~] | [x]  | [~] | SettingsPage；GetItems + 退出/清缓存                                                                                                      |
| 8    | 账户安全      | `account-security_ryx`        | `/me/security`           | Password-\*                                                                                 | [~] | [x]  | [~] | AccountSecurityPage；改密/手机/邮箱                                                                                                       |
...
| Method                                                | 用途     | API | Mock | H5             |
| ----------------------------------------------------- | -------- | --- | ---- | -------------- |
| `TmcApiOrderUrl-Order-List`                           | 订单列表 | [x] | [x]  | [x]            |
| `TmcApiOrderUrl-Order-Detail`                         | 详情     | [x] | [x]  | [x] 酒店详情页 |
