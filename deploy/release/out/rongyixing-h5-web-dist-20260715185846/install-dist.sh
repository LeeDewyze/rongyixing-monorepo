...
INSTALL_DIR="${INSTALL_DIR:-/opt/rongyixing}"
INSTALL_NGINX="${INSTALL_NGINX:-1}"
SERVER_NGINX_TARGET="${SERVER_NGINX_TARGET:-/etc/nginx/conf.d/rongyixing-dist.conf}"
...
render_template() {
  local target="$1"
  local escaped_install_dir escaped_server_name escaped_listen
