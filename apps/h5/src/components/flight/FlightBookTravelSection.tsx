...
export function FlightBookTravelSection({
  ...
  const showApproverPicker = shouldShowApproverPicker({ init, policy, staff });
  ...
  for (const passenger of passengers) {
    const staff = staffs?.find(
      (item) =>
        ...
        String(passenger.passenger.AccountId ?? passenger.id),
    );
