...
const authorizedContactAddButtonClass = `flex h-[42px] w-full items-center justify-center gap-1.5 rounded-lg bg-white text-[12px] font-normal leading-none text-[#2768FA] active:opacity-70 ${HOTEL_DETAIL_FONT}`;
