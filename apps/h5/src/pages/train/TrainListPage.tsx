    ...
    <div className="ryx-viewport-h relative overflow-hidden bg-[#F5F6F9]">
      ...
      >
        ...
        {showPolicyFilter && policyFilterEnabled && filterPassengerName ? (
          <button
            type="button"
            className="mx-3 mt-2 flex w-[calc(100%-1.5rem)] items-center gap-2 rounded-xl border border-[#D6E4FF] bg-[linear-gradient(90deg,#F5F8FF_0%,#FFFFFF_100%)] px-3 py-2.5 text-left shadow-[0_1px_4px_rgba(39,104,250,0.06)] active:opacity-90"
