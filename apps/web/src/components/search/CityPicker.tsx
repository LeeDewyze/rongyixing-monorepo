...
export function CityPicker<T>({
  ...
  return (
    <div className="absolute inset-0 z-[60] flex min-h-0 flex-col overflow-hidden">
      <PickerShell
        title={title}
        ...
        {isSearching ? (
          <div className={tone === "form" ? "px-4 pb-6 pt-3" : "pb-6"}>
            {visibleSearchResults.length === 0 ? (
              ...
              <ul
                className={tone === "form" ? "overflow-hidden rounded-xl bg-white shadow-sm" : ""}
              >
          ...
          <>
            {showHistory && historyRows.length > 0 ? (
              <section
                className={
                  tone === "form" ? "mx-4 mb-3 rounded-xl bg-white/70 pb-3 shadow-sm" : "pb-2"
                }
              >
            ...
            <ul
              className={
                tone === "form"
                  ? "mx-4 overflow-hidden rounded-xl bg-white pb-16 shadow-sm"
                  : "pb-16"
              }
            >
              {letters.map((letter) => (
