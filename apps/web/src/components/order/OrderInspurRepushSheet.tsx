  ...
  return (
    <div className={`fixed inset-0 z-[70] flex flex-col justify-end bg-black/40 ${className}`}>
      ...
      <form
        ...
        className="mx-auto flex max-h-[82dvh] w-full max-w-[520px] flex-col overflow-hidden rounded-t-2xl bg-white pb-[max(1rem,env(safe-area-inset-bottom))] shadow-[0_-12px_36px_rgba(15,23,42,0.16)]"
      >
