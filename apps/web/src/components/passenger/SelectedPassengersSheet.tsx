...
interface SelectedPassengersSheetProps {
  ...
  /** When true, overlay is scoped to the picker column instead of the viewport. */
  embedded?: boolean;
}
...
export function SelectedPassengersSheet({
  ...
  const overlayClass = embedded
    ? "absolute inset-0 z-[70] flex flex-col justify-end bg-black/40"
    : "fixed inset-0 z-[70] flex flex-col justify-end bg-black/40";
