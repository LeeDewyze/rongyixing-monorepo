...
export function FlightModifySearchSheet({
  ...
  const pickerOpen = form.picker !== null || calendarOpen;
  ...
  return (
    <>
      <div
        className={`train-modify-search-sheet${visible ? " train-modify-search-sheet--visible" : ""}${pickerOpen ? " train-modify-search-sheet--picker-open" : ""}`}
        role="dialog"
        aria-modal="true"
        aria-label="修改城市"
      >
