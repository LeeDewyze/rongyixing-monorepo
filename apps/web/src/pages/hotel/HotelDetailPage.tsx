...
export function HotelDetailPage() {
  ...
  return (
    <div className={WEB_PAGE_ROOT}>
      <div className={`${WEB_PAGE_BODY} pb-[calc(1rem+env(safe-area-inset-bottom))]`}>
        <HotelDetailHero
        ...
        {stickyVisible ? (
          <div
            ref={stickyRef}
            className="sticky top-0 z-30 overflow-hidden shadow-[0_2px_12px_rgba(142,200,255,0.35)]"
        ...
        <section
          ...
          className="mx-3 mt-2 shrink-0 space-y-2 pb-2"
        >
          ...
          {isFetching ? (
            <p className="py-1 text-right text-[12px] text-[#999999]">更新中…</p>
          ) : null}
          {rooms.length === 0 ? (
