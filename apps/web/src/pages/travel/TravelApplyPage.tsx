...
import {
  ...
  WEB_PAGE_BOTTOM_BAR,
  WEB_PAGE_ROOT,
  WEB_PAGE_STICKY_HEADER,
} from "@/lib/web-page-layout";
...
const TRAVEL_APPLY_BACKGROUND = { background: "var(--brand-form-header-gradient)" } as const;
...
export function TravelApplyPage() {
  ...
  return (
    <div className={WEB_PAGE_ROOT} style={TRAVEL_APPLY_BACKGROUND}>
      <div className={`${WEB_PAGE_STICKY_HEADER} z-30`} style={TRAVEL_APPLY_BACKGROUND}>
