 ...
 * mounts. The server redirects back to the app with
 * `wechatPayResultNumber=<OutTradeNo>`; confirm the payment with Pay-Process,
 * preferring the channel/product type saved before the redirect so tourist
 * orders hit the tourist method. Returns true when a marker was consumed.
 */
